...
#define SPI_LOWER_BYTE_DESTINATION 1
#define SPI_HIGHER_BYTE_DESTINATION 2
#define SPI_SIGN_DESTINATION 0
...
#define FEED_LOWER_BYTE 10
#define FEED_HIGHER_BYTE 11
#define CODE_IDX 0
